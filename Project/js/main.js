...
var file_name="structureC1.json"
var file_namev2="structureC2.json"
var version2 = true


var tree_branch = false
var tree_branch_parent = true
var tree_branch_color = "black"
var strokeness = 120
var default_strokeness = 50
var hover_percent_parent = false
var square = false
var rect_percent = true
var value_percent_top = true
...
//       .style("fill-opacity", 1e-6);
  ...
  var rect = nodeEnter.append("rect")
    ...
    nodeEnter.append("svg:image")
        .attr("xlink:href",  function(d){return ((d.children || d._children) || version2) && d.type=='categorical' ? 'img/cat.png' : 'img/num.png'})
        .attr("x", "-76")
        .attr("y", "-74")
        .attr("width", "20")
        .attr("height", "20")
